...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------- 2. Datos de productos ----------
     ...
     - "price" se deja vacío a propósito: escribe aquí el texto del precio, por ejemplo "Desde $90.000".
       Mientras esté vacío, la tarjeta simplemente no muestra ninguna línea de precio.
     - Si un producto tiene más de un color (ej. azul/rosado), no hace falta declarar variantes:
       simplemente se genera un solo video que ya incluye el cambio de color con transición suave
       (ver carpeta assets/productos — esos videos se armaron fusionando ambos colores).
  */
  const PRODUCTS = [
    { code:'BA-001', category:'maternidad', categoryLabel:'Maternidad', badge:'Personalizable', tone:'pink',
      ...
      price:'', overlay:'', image:'assets/productos/ba-001-cojin-lactancia.mp4' },
    ...
    { code:'BA-002', category:'baño', categoryLabel:'Baño', badge:'Kit coordinado', tone:'blue',
      ...
      price:'', overlay:'', image:'assets/productos/ba-002-kit-toalla-babero-sacagases.mp4' },
    ...
    { code:'BA-003', category:'descanso', categoryLabel:'Descanso', badge:'Descanso supervisado', tone:'pink',
      ...
      price:'', overlay:'', image:'assets/productos/ba-003-nido-bebe.mp4' },
    ...
    { code:'BA-004', category:'baño', categoryLabel:'Baño', badge:'Algodón suave', tone:'blue',
      ...
      price:'', overlay:'', image:'assets/productos/ba-004-salida-bano-bebe.mp4' },
    ...
    { code:'BA-005', category:'nacimiento', categoryLabel:'Nacimiento', badge:'Primeros días', tone:'pink',
      ...
      price:'', overlay:'', image:'assets/productos/ba-005-sabanita-cargar.mp4' },
    ...
    { code:'BA-006', category:'decoración', categoryLabel:'Decoración', badge:'Espacio reservado', tone:'pink',
      ...
      price:'', overlay:'Cuadro de bienvenida personalizado', image:'assets/productos/ba-006-cuadro-bienvenida.mp4' },
    ...
    { code:'BA-007', category:'ropa', categoryLabel:'Ropa', badge:'Espacio reservado', tone:'pink',
      ...
      price:'', overlay:'Mamelucos y camisetas', image:'assets/productos/ba-007-mamelucos-camisetas.mp4' },
    ...
    { code:'BA-009', category:'dormitorio', categoryLabel:'Dormitorio', badge:'Hecho a la medida', tone:'blue',
      ...
      price:'', overlay:'', image:'assets/productos/ba-009-juego-cuna.mp4' },
    ...
    { code:'BA-011', category:'bolsos', categoryLabel:'Bolsos', badge:'Espacio reservado', tone:'blue',
      ...
      price:'', overlay:'Bolso tipo morral', image:'assets/productos/ba-011-bolso-morral.mp4' },
    ...
    { code:'BA-012', category:'bolsos', categoryLabel:'Bolsos', badge:'Espacio reservado', tone:'blue',
      ...
      price:'', overlay:'Bolso cuadrado', image:'assets/productos/ba-012-bolso-cuadrado.mp4' },
    ...
    { code:'BA-013', category:'organización', categoryLabel:'Organización', badge:'Espacio reservado', tone:'blue',
      ...
      price:'', overlay:'Pañalera ovalada', image:'assets/productos/ba-013-panalera-ovalada.mp4' },
    ...
    { code:'BA-014', category:'organización', categoryLabel:'Organización', badge:'Espacio reservado', tone:'blue',
      ...
      price:'', overlay:'Canasta organizadora', image:'assets/productos/ba-014-canasta-bebe.mp4' },
    ...
    { code:'BA-015', category:'otros', categoryLabel:'Otros', badge:'Espacio reservado', tone:'pink',
      ...
      price:'', overlay:'Bolsa reutilizable', image:'assets/productos/ba-015-bolsa-reutilizable.mp4' },
    ...
    { code:'BA-016', category:'baño', categoryLabel:'Baño', badge:'Línea familiar', tone:'blue',
      ...
      price:'', overlay:'', image:'assets/productos/ba-016-salida-bano-jovenes-adultos.mp4' },
    ...
    { code:'BA-017', category:'baño', categoryLabel:'Baño', badge:'Para todas las edades', tone:'blue',
      ...
      price:'', overlay:'', image:'assets/productos/ba-017-toalla-personalizada.mp4' },
    ...
    { code:'BA-018', category:'kits', categoryLabel:'Kits', badge:'Regalo completo', tone:'pink',
      ...
      price:'', overlay:'', image:'assets/productos/ba-018-kit-completo.mp4' },
    ...
    { code:'BA-019', category:'decoración', categoryLabel:'Decoración', badge:'Formas y diseños', tone:'pink',
      ...
      price:'', overlay:'', image:'assets/productos/ba-019-cojines-infantiles.mp4' },
  ];
  ...
  function renderProducts() {
    grid.innerHTML = PRODUCTS.map(p => {
      const poster = p.image ? p.image.replace(/\.mp4$/, '.jpg') : '';
      return `
      <article class="product-card" data-category="${p.category}" data-tone="${p.tone}">
        <div class="product-image">
          ${p.image ? `
          <video src="${p.image}" poster="${poster}" autoplay muted loop playsinline preload="metadata">
            <img src="${poster}" alt="${p.title}">
          </video>
          ` : `
          <!-- IMAGEN/VIDEO PRODUCTO "${p.title}": reemplaza el contenido de este div por
               <img src="tu-imagen.jpg" alt="${p.title}"> o un <video> como en los demás productos -->
